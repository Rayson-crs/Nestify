...
Path('apps/desktop/src/app/useSearchWorkspace.ts').write_text(r'''import { useCallback, useEffect, useRef, useState } from 'react'
...
''', encoding='utf-8')
print('useSearchWorkspace.ts written')
