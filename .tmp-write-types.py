...
Path('apps/desktop/src/app/types.ts').write_text(r'''import type { Dispatch, RefObject, SetStateAction } from 'react'
...
''', encoding='utf-8')
print('types.ts written', Path('apps/desktop/src/app/types.ts').stat().st_size)
