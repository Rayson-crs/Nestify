...
>
> 当前状态（2026-09-17 / v1.8.0）：仓库名是 nestify。Query / Writer / Preview / Library-removal Worker 已存在。扫描、规则、计划、重复分析仍有 Main/Runtime 路径。缩略图取消已跨 IPC。下文历史树里的 `cuttlefish/` 不再作为当前仓库名。
