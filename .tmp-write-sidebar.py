...
Path('apps/desktop/src/components/app/LibrarySidebar.tsx').write_text(r'''import { FolderPlus, Loader2, Pause, Play, ScanSearch, Settings2, Square, Trash2 } from 'lucide-react'
