...
Nestify is a local file-governance workbench. It indexes directories you point it at, then searches, organizes, renames, and deduplicates against that index. Disk writes only happen after a change plan is confirmed. Completed jobs can be rolled back.
